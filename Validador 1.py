...
chrome_options.add_argument("user-data-dir=C:\Perfil Chrome/Zap1")
...
arquivo = pd.read_excel(r'C:\Users\rafae\PycharmProjects\Validador de Whatsapp\base.xlsx')
...
for i, cpf in enumerate(base["cpf"]):
    ...
    try:
        elemento = WebDriverWait(navegador, 6).until(EC.presence_of_element_located(
            (By.XPATH, '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]/div/div[1]/p')))
        navegador.find_element('xpath',
                               '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]/div/div[1]/p').click()
        print(i, 'WhatsApp Válido')
        validos.append(telefone)
        base.loc[base["cpf"] == cpf, 'Whatsapp'] = 'Valido'
        base.to_excel('Numeros Validados.xlsx', index=False)
